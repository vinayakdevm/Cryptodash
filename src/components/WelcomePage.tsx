...
import { TrendingUp, BarChart3, Star, Shield, Zap, Globe } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Live cryptocurrency prices and market data updated every minute',
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    description: 'Interactive candlestick charts with historical data analysis',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'Optimized performance for seamless browsing experience',
  },
  {
    icon: Globe,
    title: 'Multi-Currency',
    description: 'View prices in USD, EUR, GBP, and JPY',
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            Your comprehensive cryptocurrency tracking platform with real-time market data,
            advanced charts, and personalized insights
          </motion.p>
          ...
          <motion.button
            ...
            className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-lg font-semibold rounded-xl shadow-lg transition-all"
          >
            Get Started
          </motion.button>
        </motion.div>
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-shadow border border-slate-200 dark:border-slate-700"
            >
